<?php 
	...
	if (isset($_POST['registrarse'])) {
		...
		if ($crud->buscarUsuario($_POST['usuario'])) {
			...
			header('Location: Login/login/error.php?mensaje=El nombre de usuario ya existe');
		}		
		...
		if ($usuario->getId()!=NULL) {
			...
			header('Location: Login/login/error.php?mensaje=Tus nombre de usuario o clave son incorrectos'); // cuando los datos son incorrectos envia a la página de error
		}
