<?php 
	...
	if (isset($_POST['registrarse'])) {
		...
		if ($crud->buscarUsuario($_POST['usuario'])) {
			...
			header('Location: error registro.php?mensaje=El nombre de usuario ya existe');
		}		
		...
		if ($usuario->getId()!=NULL) {
			...
			header('Location: cuenta.php'); //envia a la página principal
		}else if($user == ''){
		   header('Location: error.php?mensaje=Ningun usuario'); 
		}
